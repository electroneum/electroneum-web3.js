...
*/
import { BlockNumberOrTag, BlockTags } from '@etn-sc/web3-types';
...
export const testData: TestData[] = [
	...
	['blockNumber = BlockTags.SAFE', [BlockTags.SAFE, true]],
	['blockNumber = BlockTags.FINALIZED', [BlockTags.FINALIZED, true]],
