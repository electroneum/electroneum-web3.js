...
use this [template](https://github.com/electroneum/electroneum-web3.js-plugin-template) to start with development of your Web3.js plugin.
...
Below depicts a plugin user's code that does not configure an Electroneum SmartChain provider, resulting in a thrown [ProviderError](/api/web3-errors/class/ProviderError) when calling `customRpcMethod`:
...
You may find it helpful to reference a complete example for developing and using a web3 plugin. The [Web3.js Electroneum Plugin](https://github.com/electroneum/electroneum-web3.js-plugin-chainlink/) repository provides an excellent example which you can check out.
