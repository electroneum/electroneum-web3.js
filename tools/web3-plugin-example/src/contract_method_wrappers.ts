...
*/
import { Web3PluginBase } from '@etn-sc/web3-core';
import Contract from '@etn-sc/web3-eth-contract';
import { Address, ContractAbi, DataFormat, DEFAULT_RETURN_FORMAT, Numbers } from '@etn-sc/web3-types';
import { format, numberToHex } from '@etn-sc/web3-utils';
